    ...
    drive(distance) {
      if (this.tank - distance/this.milesPerGallon > 0) {
          ...
          for (let i = 0; i < distance; i++) {
              this.odometer += 1;
              if (this.tank - 1/this.milesPerGallon > 0) {
...
class Lambdasian {
    constructor(lambObj) {
        this.name = lambObj.name;
        this.age = lambObj.age;
        this.location = lambObj.location;
    }
...
class Instructor extends Lambdasian{
    ...
    changeGrade(student) {
        student.grade += Math.floor(Math.random() * 100) * (Math.round(Math.random()) ? 1 : -1);
    }
}
  /*
    TASK 5
